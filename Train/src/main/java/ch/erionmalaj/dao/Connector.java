...
public class Connector {
    ...
    public void setConfiguration() {
        configuration.setProperty("hibernate.connection.url", "jdbc:mysql://localhost:3306/TrainDB");
        configuration.setProperty("hibernate.connection.username", "TrainDBUser");
        configuration.setProperty("hibernate.connection.password", "Meisterschaftsklasse2023_");
